...
void reset_LI() {
    ...
    // Save reset values to EEPROM
    EEPROM.writeFloat(SOC_LI_ADDRESS, totalSOCDrop);
    EEPROM.writeFloat(SOH_LI_ADDRESS, SOH);
    EEPROM.commit();
...
void timeRemaining_LI( float totalCapacity,float soc)
{
  float batteryCapacity=(totalCapacity*(soc/100));
